...
class SignupPage extends Component {
  ...
  validate = () => {
    ...
    if(this.state.password!= this.state.confirmPassword){
      errors['notMatch']= "Password is not match!";
    }
    if (!('notMatch' in errors)&&!error) return null;
    if(error){
  ...
  submitHandler = event => {
    ...
    if (!error) {
      axios.post(SERVER_URL+'/api/register', this.state).then(
        (result)=>{
          console.log(result)
          if(result.data.message== "email in use"){
              ...
              <Grid className="accountContent">
                ...
                <Form onSubmit={this.submitHandler}>
                  ...
                  <TextField
                    ...
                    helperText={
                      this.state.error.password ? this.state.error.password : this.state.error.notMatch ? this.state.error.notMatch: ''
                    }
                  />
                  <TextField
                    ...
                    helperText={
                      this.state.error.confirmPassword
                        ? this.state.error.confirmPassword
                        : this.state.error.notMatch ? this.state.error.notMatch: ''
                    }
                  />
